...
config :app, AppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "/qu/TBX3jnNixoV5DLn0XcQNsOhLXRjkYV2qsHV5cr4jLWEk8J4ICgV4vyjrU/0r",
  watchers: [
...
config :app, AppWeb.OMDb,
  api_key: System.get_env("OMDB_API_KEY") ||
           raise("Set OMDB_API_KEY in your shell before running mix phx.server")

# config :app, App.Mailer,
#   adapter: Swoosh.Adapters.Local   # stores in tmp/local for dev
