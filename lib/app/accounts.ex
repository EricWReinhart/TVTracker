defmodule App.Accounts do
  ...
  def update_user_name(user, attrs) do
    Repo.update(User.name_changeset(user, attrs))
  end

  def change_user_birthday(user, attrs \\ %{}) do
    User.birthday_changeset(user, attrs)
  end

  def update_user_birthday(user, attrs) do
    Repo.update(User.birthday_changeset(user, attrs))
  end
